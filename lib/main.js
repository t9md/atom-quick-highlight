...
module.exports = {
  ...
  getKeywordManager () {
    ...
    if (!this.keywordManager) this.keywordManager = new KeywordManager(this.emitter, this.statusBarService)
  ...
  consumeStatusBar (service) {
    ...
    if (this.keywordManager) {
      this.keywordManager.statusBarManager.initialize(this.statusBarService)
